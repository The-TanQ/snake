...
const images = [ // array with images path
	'sources/images/apple.svg',
	'sources/images/carrot.svg',
	'sources/images/eggplant.svg',
	'sources/images/banana.svg',
];
let img = new Image();
...
bombImg.src = '/sources/images/bomb.svg';

// аudio sounds
const audio = [ // array with audio
	'./sources/sound/audio_eat.mp3',
	'./sources/sound/audio_dead.mp3',
	'./sources/sound/audio_hit.mp3',
];
...
// draw bomb
function drawBomb() { // add bomb function
